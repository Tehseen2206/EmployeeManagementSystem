...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@ModelAttribute Employee employee) {
		...
		if(emp != null) {
			mav.addObject("status","data added sucessfully....");
		}
		else {
			mav.addObject("status","data not added....");
		}
		return mav;
    }
    @RequestMapping("/emplogin")
    public ModelAndView checkCredentials(@RequestParam String email,@RequestParam String password,HttpSession session) {
