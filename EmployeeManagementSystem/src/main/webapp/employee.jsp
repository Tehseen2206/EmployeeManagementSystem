...
<body>
    ...
    <nav>
        ...
        <a href="view?email=${sessionScope.email}">View Profile</a>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
                home: 'url(https://www.bamboohr.com/blog/category/media_1c6448191b07d53562512e81993e8e91cc4b40781.png?width=750&format=webply&optimize=medium)',
