...
<body>
    ...
    <div id="home" class="container">
        ...
        <form action = 'search'>
            <h1 style="text-align: center;">Search Employee Here</h1>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
                home: 'url(https://www.bamboohr.com/blog/media_1ff2cc8213d6b761c6fb3e2f4cb1ce8dcf0e666cb.png?width=2000&format=webply&optimize=medium)',
