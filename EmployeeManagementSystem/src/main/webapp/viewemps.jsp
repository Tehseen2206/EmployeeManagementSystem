...
<body>
			    ...
			    <th>Id</th>
        		  ...
        		  <c:forEach items="${empList}" var="employee">
					    ...
					    <td>${employee.id}</td>
        		  			...
        		  			<td>
        		  				<a href = 'edit.jsp?id=${employee.id}&email=${employee.email}&password=${employee.password}&name=${employee.name}&age=${employee.age}&mobile=${employee.mobile}&department=${employee.department}&address=${employee.address}'>Edit</a>
        		  			</td>
        		  			<td>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
                home: 'url(https://www.bamboohr.com/blog/category/media_12f0ec405beb21d5bd1dd271f05416bfd1b01f9b8.png?width=750&format=webply&optimize=medium)',
