...
<body>
    ...
    <div id="home" class="container">
		<form action = 'emplogin'>
            ...
            <% if(request.getAttribute("validate") != null){ %>
            		<h1 style="text-align: center;"><%=request.getAttribute("validate")%> </h1>
            <%} %>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
                home: 'url(https://www.bamboohr.com/blog/category/media_1eabc797711c078ba81e956f2baee4a243d3238ac.png?width=750&format=webply&optimize=medium)',
